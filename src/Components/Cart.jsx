  ...
  return (
    <>
      <div className="container my-5" style={{ width: "54%" }}>
        {cart.length == 0 ? (
          ...
          cart.map((product) => {
            return (
              <>
                <div className="card mb-3 my-5" style={{ maxWidth: "800px" }}>
      ...
      {cart.length != 0 && (
        ...
        >
          <button className="btn btn-warning mx-5 " onClick={() => setcart("")}>
            <Link to={'/'} style={{textDecoration:'none',color:'white'}}>Checkout</Link>
          </button>
